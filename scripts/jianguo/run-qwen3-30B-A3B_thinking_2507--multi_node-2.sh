...
CKPT_ARGS=(
   ...
   --load $BASE_DIR/checkpoints/miles/QWEN-3-30B-A3B-Thinking-2507_miles/
   --save $BASE_DIR/checkpoints/miles/QWEN-3-30B-A3B-Thinking-2507_miles/
   --save-interval 120
)
...
WANDB_ARGS=(
   ...
   --wandb-group QWEN-3-30B-A3B-thinking-2507-2-nodes-optimized-kl-$(date +%Y%m%d-%H%M%S)
