...
export 5=${BASE_DIR:-"/fsx/home/jianguozhang"}
...
if [ "$CONDA_PREFIX" != "/fsx/home/jianguozhang/micromamba/envs/slime" ]; then
  echo "Error: CONDA_PREFIX is not set to expected value"
  echo "Expected: /fsx/home/jianguozhang/micromamba/envs/slime"
